...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    # DigitalOcean Inference serverless rates.
    # Source: https://docs.digitalocean.com/products/inference/details/pricing/
    (
        "digitalocean",
        "deepseek-v4-pro",
    ): PricingEntry(
        input_cost_per_million=Decimal("0.87"),
        output_cost_per_million=Decimal("1.74"),
        cache_read_cost_per_million=Decimal("0.174"),
        source="official_docs_snapshot",
        source_url=(
            "https://docs.digitalocean.com/products/inference/details/pricing/"
        ),
        pricing_version="digitalocean-inference-2026-08",
    ),
    (
        "digitalocean",
        "kimi-k3",
    ): PricingEntry(
        input_cost_per_million=Decimal("2.85"),
        output_cost_per_million=Decimal("14.25"),
        cache_read_cost_per_million=Decimal("0.285"),
        source="official_docs_snapshot",
        source_url=(
            "https://docs.digitalocean.com/products/inference/details/pricing/"
        ),
...
def resolve_billing_route(
    ...
    if (
        ...
        or base_url_host_matches(base_url or "", "inference.do-ai.run")
    ):
        return BillingRoute(
...
def get_pricing_entry(
    ...
    if route.billing_mode == "official_docs_snapshot":
