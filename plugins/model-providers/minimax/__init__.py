...
with /anthropic. Users can opt MiniMax-M3 into either official
OpenAI-compatible endpoint (api.minimax.io/v1 or api.minimaxi.com/v1); those
routes need MiniMax-specific reasoning controls in extra_body.
"""
...
def _is_minimax_openai_base_url(base_url: str | None) -> bool:
...
class MiniMaxProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        """Emit M3 reasoning controls for MiniMax's official /v1 endpoints.
        ...
        """
        if not _is_minimax_openai_base_url(base_url) or not _is_minimax_m3(model):
            return {}, {}
