...
export function HermesConsoleModal({ open, onClose }: HermesConsoleModalProps) {
  ...
  useEffect(() => {
    ...
    const term = new XtermTerminal({
      ...
      theme: buildTerminalTheme(
        theme.terminalBackground ?? "#ffffff",
        theme.terminalForeground ?? "#1e293b",
      ),
    });
  ...
  return createPortal(
    <div
      ref={modalRef}
      className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/25 p-3 sm:p-4"
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ backgroundColor: theme.terminalBackground ?? "#ffffff" }}
        >
          <div
            ref={hostRef}
