...
const PROJECT_LIGHT_TYPOGRAPHY: ThemeTypography = {
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Project Hermes Light",
  description: "InferScope-inspired light operations dashboard",
  palette: {
    background: { hex: "#f8f9fb", alpha: 1 },
    midground: { hex: "#1e293b", alpha: 1 },
    foreground: { hex: "#3b82f6", alpha: 1 },
    warmGlow: "rgba(59, 130, 246, 0.12)",
    noiseOpacity: 0,
  },
  typography: PROJECT_LIGHT_TYPOGRAPHY,
  ...
  seriesColors: {
    inputTokenAccent: "#3b82f6",
    outputTokenAccent: "#16a34a",
  },
  swatchColors: ["#f8f9fb", "#3b82f6", "#1e293b"],
};
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Project Hermes Light (Large)",
  description: "Project Hermes Light with bigger fonts and roomier spacing",
  palette: defaultTheme.palette,
  typography: {
    ...PROJECT_LIGHT_TYPOGRAPHY,
    baseSize: "18px",
    lineHeight: "1.65",
  },
  layout: {
